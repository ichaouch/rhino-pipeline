...
########################################################################################################
PIPELINE_DIR <- "/mnt/StudentFiles/2020-21/Project4/ONTrack"
#MINICONDA DIR
MINICONDA_DIR <- "/mnt/StudentFiles/2020-21/Project4/miniconda3"
#basecaller_dir
BASECALLER_DIR <- "/path/to/ont-guppy-cpu/bin/"
#NCBI nt database
NTDB <- "/mnt/StudentFiles/2020-21/Project4/NCBI_nt_db"
